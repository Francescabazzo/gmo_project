...
def initialize_run(jobShopEnv, **kwargs):
    ...
    # It creates a new class, creator.Fitness, that derives from base.Fitness. 
    # The -1 indicates that the problem is a minimization problem. 
    if not hasattr(creator, "Fitness"):
        creator.create("Fitness", base.Fitness, weights=(-1.0,))
    
    # It creates a new class, creator.Individual, where each individual inherits from list. 
    # It also has an attribute fitness to keep track of the fitness. 
